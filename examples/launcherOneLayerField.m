...
% create interactions
sim.addElement(LateralInteractions1D('u -> u', fieldSize, sigma_exc, 0.0, sigma_inh, 0.0, 0.0, true, true), ...
...
gui.addControl(ParameterSlider('c_exc', 'u -> u', 'amplitudeExc', [0, 100], '%0.1f', 1, ...
  'strength of lateral excitation'), [2, 1]);
gui.addControl(ParameterSlider('c_inh', 'u -> u', 'amplitudeInh', [0, 100], '%0.1f', 1, ...
  'strength of lateral inhibition'), [2, 2]);
gui.addControl(ParameterSlider('c_glob', 'u -> u', 'amplitudeGlobal', [0, 5], '%0.2f', -1, ...
