...
% create interactions
sim.addElement(MexicanHatKernel2D('u -> u', [fieldSize, fieldSize], sigma_exc, sigma_exc, 0, ...
  sigma_inh, sigma_inh, 0), 'field u', [], 'field u');
...
elementGroups = {'field u', 'u -> u', 'u -> u (global)', ...
