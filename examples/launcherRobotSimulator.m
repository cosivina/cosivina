...
% 
% NOTE: The x-axes of the field plot and dynamics plots are flipped (they
% go from negative to positive) to make the mapping from the robot view to
% the dynamics more intuitive.
