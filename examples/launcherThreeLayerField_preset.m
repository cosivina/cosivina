...
sim.addElement(GaussKernel1D('noise kernel w', fieldSize, 0, 0, true, true), 'noise v', 'output', 'field w');
...
gui = StandardGUI(sim, [50, 25, 900, 750], 0.05, [0.0, 1/4, 1.0, 3/4], [3, 1], 0.06, [0.0, 0.0, 1.0, 1/4], [8, 4], ...
...
gui.addControl(ParameterSlider('c_s1', 'stimulus 1', 'amplitude', [0, 30], '%0.1f', 1, ...
...
gui.addControl(ParameterSlider('c_s2', 'stimulus 2', 'amplitude', [0, 30], '%0.1f', 1, ...
...
gui.addControl(ParameterSlider('c_s3', 'stimulus 3', 'amplitude', [0, 30], '%0.1f', 1, ...
