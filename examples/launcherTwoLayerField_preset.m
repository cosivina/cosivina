...
gui = StandardGUI(sim, [50, 50, 900, 750], 0.05, [0.0, 1/4, 1.0, 3/4], [2, 1], 0.06, [0.0, 0.0, 1.0, 1/4], [7, 4], ...
...
gui.addControl(ParameterSlider('uv_li', 'v -> u (local)', 'amplitude', [0, 20], '%0.1f', -1, ...
