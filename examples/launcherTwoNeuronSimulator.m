...
gui.addVisualization(XYPlot({[], 'node u', 'node u', 'node u'}, ...
  {samplingRange(1):samplingResolution:samplingRange(2), 'attractorPositions', 'repellorPositions', 'activation'}, ...
  {'node u', 'node u', 'node u', 'node u'}, ...
  {'sampledRatesOfChange', 'attractorValues', 'repellorValues' 'rateOfChange'}, ...
