  ...
  methods
    ...
    function obj = init(obj, figureHandle)
      ...
      set(obj.axesHandle, 'CLim', obj.imageRange, 'GridLineStyle', '-', ...
        'XTick', 0.5:obj.inputSize(2):obj.inputSize(2)^2+0.5, 'XTickLabel', [], 'XGrid', 'on', 'XColor', [1, 1, 1], ...
        'YTick', 0.5:obj.inputSize(1):obj.inputSize(1)^2+0.5, 'YTickLabel', [], 'YGrid', 'on', 'YColor', [1, 1, 1], ...
        obj.axesProperties{:});
      colormap(jet(256));
